            ...
            return (
                <div className="App-card player-card playerCard">
                        <p className="name">
                            ...
                            <a className="steam-interact btn btn-primary" href={"steam://friends/add/" + this.state.info.steam_id}> Add Friend </a>
                            <a className="steam-interact btn btn-primary" href={"steam://friends/message/" + this.state.info.steam_id}> Message </a>
